...
public enum RscpTag : uint
{
    ...
    DB_REQ_HISTORY_TIME_START     = 0x06000001,
    DB_REQ_HISTORY_TIME_INTERVAL  = 0x06000002,
    DB_REQ_HISTORY_TIME_SPAN      = 0x06000003,
    DB_REQ_HISTORY_DATA_DAY       = 0x06040100,
    DB_REQ_HISTORY_DATA_WEEK      = 0x06040200,
    DB_REQ_HISTORY_DATA_MONTH     = 0x06040300,
    DB_REQ_HISTORY_DATA_YEAR      = 0x06040400,
    // DB (0x06) — response tags
    DB_HISTORY_DATA_DAY           = 0x06840100,
    DB_HISTORY_DATA_WEEK          = 0x06840200,
    DB_HISTORY_DATA_MONTH         = 0x06840300,
    DB_HISTORY_DATA_YEAR          = 0x06840400,
